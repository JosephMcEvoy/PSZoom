...
.SYNOPSIS
Retrieve all location id's or filter on Parent Location ID.

.DESCRIPTION
Retrieve all location id's or filter on Parent Location ID.

.PARAMETER ParentLocationId
A unique identifier for the parent location. For instance, 
if a Zoom Room is located in Floor 1 of Building A, 
the location of Building A will be the parent location of Floor 1. 
