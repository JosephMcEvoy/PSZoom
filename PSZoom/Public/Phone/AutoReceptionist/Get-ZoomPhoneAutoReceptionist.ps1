...
.SYNOPSIS
List auto receptionist on a Zoom account.
...
.LINK
https://developers.zoom.us/docs/api/rest/reference/phone/methods/#operation/listAutoReceptionists

.EXAMPLE
Return a list of all the Auto Receptionist.
...
Get-ZoomPhoneAutoReceptionist -AutoReceptionistId "3vt4b7wtb79q4wvb"

.EXAMPLE
Get a page of zoom users with phone accounts.
Get-ZoomPhoneAutoReceptionist -PageSize 100 -NextPageToken "8w7vt487wqtb457qwt4"

#>

function Get-ZoomPhoneAutoReceptionist {
    [CmdletBinding(DefaultParameterSetName="AllData")]
    [Alias("Get-ZoomPhoneAutoReceptionists")]
    param (
        [Parameter(
    ...
    process {
        $baseURI = "https://api.$ZoomURI/v2/phone/auto_receptionists"
        ...
        switch ($PSCmdlet.ParameterSetName) {
            ...
            "SelectedRecord" {
                $AggregatedResponse = Get-ZoomPaginatedData -URI $baseURI -ObjectId $AutoReceptionistId
            }
