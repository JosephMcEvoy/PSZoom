...
.DESCRIPTION
List account call logs for Zoom Phone.
...
.PARAMETER Full
The full details of each call log.
...
.EXAMPLE
Get-ZoomPhoneCallLogs -CallLogId "abc123def456"

.EXAMPLE
Get-ZoomPhoneCallLogs -Full

.LINK
https://developers.zoom.us/docs/api/rest/reference/phone/methods/#operation/listAccountCallLogs
...
function Get-ZoomPhoneCallLogs {
    ...
    process {
        $baseURI = "https://api.$ZoomURI/v2/phone/call_logs"
        ...
        switch ($PSCmdlet.ParameterSetName) {
            ...
            "SelectedRecord" {
                $AggregatedResponse = Get-ZoomPaginatedData -URI $baseURI -ObjectId $CallLogId
            }
