BeforeAll {
    ...
    $script:MockResponse = Get-Content -Path $PSScriptRoot/../../../Fixtures/MockResponses/w-e-b-i-n-a-r-r-e-g-i-s-t-r-a-n-t-q-u-e-s-t-i-o-n-get.json -Raw | ConvertFrom-Json
}
