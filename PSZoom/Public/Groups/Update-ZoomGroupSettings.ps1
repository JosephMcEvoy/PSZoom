...
.LINK
https://marketplace.zoom.us/docs/api-reference/zoom-api/groups/updategroupsettings
...
Get-ZoomGroups | where-object {$_ -match 'Jedi'} | Update-ZoomGroupSettings @updateParams
