...
.EXAMPLE
Update a user's Auto Receptionist Voicemail permissions
Update-ZoomPhoneAutoReceptionistPolicySetting -AutoReceptionistId "5e7tv9y80bu9n-i0nbvc7e5x6" -DelegateVMAccessUserID "bwo8arsny6b328" -DelegateUserPermitVMDelete $false -DelegateUserPermitVMDownload $true

.LINK
https://developers.zoom.us/docs/api/rest/reference/phone/methods/#operation/updatePolicy


#>

function Update-ZoomPhoneAutoReceptionistPolicySetting {    
    [alias("Update-ZoomPhoneAutoReceptionistPolicySettings")]
