...
.DESCRIPTION
List phone recordings for a specific Zoom Phone user.
...
.EXAMPLE
Get-ZoomPhoneUserRecordings -UserId "abc123" -PageSize 50

.LINK
https://developers.zoom.us/docs/api/rest/reference/phone/methods/#operation/listUserRecordings

#>

function Get-ZoomPhoneUserRecordings {
    ...
    process {
        foreach ($user in $UserId) {
            $baseURI = "https://api.$ZoomURI/v2/phone/users/$user/recordings"
