BeforeAll {
    ...
    $script:MockResponse = Get-Content "$PSScriptRoot/../../../Fixtures/MockResponses/p-h-o-n-e-o-u-t-b-o-u-n-d-c-a-l-l-e-r-i-d-c-u-s-t-o-m-i-z-e-d-n-u-m-b-e-r-delete.json" -Raw | ConvertFrom-Json
}
