...
function New-ZoomMeeting {
  ...
  process {
    ...
    #The following parameters are added by default as they are requierd by all parameter sets so they are automatically added t the request body.
    $RequestBody = @{
        'api_key'      = $ApiKey
...
$paramsScheduled = @{
    ...
    ContactEmail          = 'jmcevoy@foleyhoag.com'
